		...
		participants.forEach(function(participant){
			Champion.findOne({ championId: participant.championId }, function(err, champion) {
				...
				function addToAvg(champAvg, playerStats) {
					champAvg = champAvg + (playerStats - champAvg)/ dbRegion.picks;
				}
				
				addToAvg(dbRegion.inGameAvgs.creepScore, participant.inGameStats.creepScore);
				addToAvg(dbRegion.inGameAvgs.wardsPlaced, participant.inGameStats.wardsPlaced);
				addToAvg(dbRegion.inGameAvgs.wardsKilled, participant.inGameStats.wardsKilled);
				addToAvg(dbRegion.inGameAvgs.kills, participant.inGameStats.kills);
				addToAvg(dbRegion.inGameAvgs.pentaKills, participant.inGameStats.pentaKills);
				addToAvg(dbRegion.inGameAvgs.quadraKills, participant.inGameStats.quadraKills);
