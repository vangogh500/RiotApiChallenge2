...
module.exports = {
	...
	updateChampions: function(match, participants, newMatch) {
		participants.forEach(function(participant){
			Champion.findOne({ championId: participant.champion }, function(err, champion) {
				console.log("updating champion " + participant.champion + " for player " + participant.participantId);
